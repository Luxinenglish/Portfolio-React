                ...
                <div className="backdrop-blur-xl bg-slate-900/50 rounded-3xl p-6 md:p-12 border border-purple-500/20 hover:border-purple-500/40 transition-all">
                    ...
                    <div className="grid sm:grid-cols-2 gap-4 md:gap-6 mt-8">
                        <div className="p-4 md:p-6 rounded-2xl bg-purple-500/10 border border-purple-500/20">
                            ...
                            <p className="text-sm md:text-base text-gray-400">Passionate about singing and creating musical experiences</p>
                        </div>

                        <div className="p-4 md:p-6 rounded-2xl bg-purple-500/10 border border-purple-500/20">
                            <Gamepad2 className="w-7 h-7 md:w-8 md:h-8 text-purple-400 mb-3" />
                            <h3 className="text-lg md:text-xl font-semibold mb-2">Gaming Enthusiast</h3>
                            <p className="text-sm md:text-base text-gray-400">Dedicated gamer exploring virtual worlds</p>
                        </div>

                        <div className="p-4 md:p-6 rounded-2xl bg-purple-500/10 border border-purple-500/20">
                            <Car className="w-7 h-7 md:w-8 md:h-8 text-purple-400 mb-3" />
                            <h3 className="text-lg md:text-xl font-semibold mb-2">Vehicle Aficionado</h3>
                        ...
                        <div className="p-4 md:p-6 rounded-2xl bg-purple-500/10 border border-purple-500/20">
                            ...
                            <h3 className="text-lg md:text-xl font-semibold mb-2">Tech Professional</h3>
                            <p className="text-sm md:text-base text-gray-400">Working in IT and promoting Open Source</p>
                        </div>
                    </div>
                </div>
            </div>
